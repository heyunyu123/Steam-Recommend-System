...
# set file path
path_user_inventory = 'xxxxxxxx' # your crawled user inventory txt file
...
engine = sqlalchemy.create_engine('mysql+pymysql://<mysql_user_name>:<mysql_password>@127.0.0.1/<database_name>?charset=utf8mb4') # You might need to install the pymysql package. 
